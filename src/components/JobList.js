                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="job-footers">
                                <div className="lws-type">
                                    ...
                                    {
                                        type === 'Full Time' && <div><i class="fa-solid fa-stop !text-[#FF8A00]"></i> {type} </div>  ||
                                        type === 'Internship' && <div><i class="fa-solid fa-stop !text-[#FF5757]"></i> {type} </div>  ||
                                        type === 'Remote' && <div><i class="fa-solid fa-stop !text-[#56E5C4]"></i> {type} </div>  
                                    } 
                                </div>
